...
import CrearModal from '@/Pages/Peso/Partials/CrearModal.vue';
import EditarModal from '@/Pages/Peso/Partials/EditarModal.vue';
...
onMounted(() => {
    datos.value =usePage().props.pesos.data;
    tabla()
});
