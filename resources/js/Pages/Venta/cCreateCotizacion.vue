                    ...
                    <div class="px-2 grid grid-cols-6 gap-2 xl:gap-2 mt-0 mb-2">
                        ...
                        <div v-for="(pago, index) in form.metodos_pago" :key="index"
                            ...
                            <div class="col-span-6  xl:col-span-">
                                <InputLabel for="metodos" value="Nombre"
                                ...
                                <div class="flex">
                                    <span v-if="index > 0"
                                        ...
                                        <button @click.prevent="removePago(index)" class="w-6 h-10"><i
                                                class="fas fa-times"></i></button>
                                    </span>
                        ...
                        <div class="grid grid-cols-12 gap-2 col-span-12  xl: gap-2 xl:col-span-6">
