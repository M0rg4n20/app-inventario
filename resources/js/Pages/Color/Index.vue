...
import CrearModal from '@/Pages/Color/Partials/CrearModal.vue';
import EditarModal from '@/Pages/Color/Partials/EditarModal.vue';
...
onMounted(() => {
    datos.value =usePage().props.colores.data;
    tabla()
});
