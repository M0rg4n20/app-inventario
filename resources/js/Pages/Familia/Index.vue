...
import CrearModal from '@/Pages/Familia/Partials/CrearModal.vue';
import EditarModal from '@/Pages/Familia/Partials/EditarModal.vue';
...
onMounted(() => {
    datos.value =usePage().props.familias.data;
    tabla()
});
