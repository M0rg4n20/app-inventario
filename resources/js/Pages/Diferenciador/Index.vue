...
import CrearModal from '@/Pages/Diferenciador/Partials/CrearModal.vue';
import EditarModal from '@/Pages/Diferenciador/Partials/EditarModal.vue';
...
const titulo="Diferenciadores"
const ruta="diferenciadores";
const tabla=()=>{
    nextTick(()=>{
...
onMounted(() => {
    datos.value =usePage().props.diferenciadores.data;
    tabla()
});
