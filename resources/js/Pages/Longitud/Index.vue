...
import CrearModal from '@/Pages/Longitud/Partials/CrearModal.vue';
import EditarModal from '@/Pages/Longitud/Partials/EditarModal.vue';
...
onMounted(() => {
    datos.value =usePage().props.longitudes.data;
    tabla()
});
                        ...
                        <div class="overflow-visible">
                            ...
                            <table id="tabla1" class="pt-3 w-full text-sm text-left text-gray-600 dark:text-gray-400">
                                ...
                                <tbody>
                                    ...
                                    <tr :key="id" v-for="{id, nombre,codigo,comentario}, index in datos" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                                   <th scope="row"
