...
onMounted(() => {
    datos.value =usePage().props.cotizaciones.data;
    tabla()
});
                            ...
                            <table id="tabla1" class="pt-3 w-full text-sm text-center text-gray-600 dark:text-gray-400">
                                <thead class="text-md text-center text-gray-700 bg-gray-200/80 dark:bg-gray-700 dark:text-gray-400">
                                    <tr>
                                        ...
                                        <th scope="col" class="w-36 border border-gray-300 dark:border-gray-500">
                                            <div class="flex justify-center">
                                                Acciones
                                            </div>
                                        </th>
                                ...
                                <tbody>
                                    <tr :key="id" v-for="{
                                        id, cliente, codigo, vendedor,  neto, total, fecha}, index in datos"
                                        ...
                                        <td scope="row" class="p-1 border text-end dark:border-gray-700">
                                            <span
                                                class="inline-block rounded bg-yellow-300 px-2 py-1 text-base font-semibold text-white mr-1 mb-1 hover:bg-yellow-400">
                                                <a :href="route('ventas.generar', id)" target="_self"><i class="fas fa-money-bill"></i></a>
                                            </span>
                                            <span
                                                class="inline-block rounded bg-sky-300 px-2 py-1 text-base font-semibold text-white mr-1 mb-1 hover:bg-sky-400">
                                                <a :href="route('cotizaciones.generar_ticket', codigo)" target="_blank"><i class="fas fa-print"></i></a>
                                            </span>
                                            <span
                                                class="inline-block rounded bg-blue-600 px-2 py-1 text-base font-semibold text-white mr-1 mb-1 hover:bg-blue-700">
                                                <Link :href="route('cotizaciones.edit', id)"><i class="fas fa-edit"></i>
                                            </Link>
                                            </span>
                                            <span
