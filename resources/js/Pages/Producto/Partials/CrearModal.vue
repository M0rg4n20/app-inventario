...
const submit = () => {
  ...
  form.post(route('productos.store'), {
    ...
    onSuccess: () => {
      ...
      ok('Producto Creado')
      form.reset()
      previewImage.value = "/images/productos/temp_producto.png";
      previewImage2.value = "/images/productos/temp_producto.png";
        ...
        <form @submit.prevent="submit">
          <div class="px-2 grid grid-cols-12  gap-3 xl:gap-3 mt-2 mb-2">
            ...
            <div class="col-span-12">
              ...
              <TextInput id="nombre" type="text" v-model="form.nombre" autocomplete="nombre" placeholder="Ingrese nombre"
                readonly />
            ...
            <div class="hidden">
              ...
              <Multiselect id="categoria_id" v-model="form.categoria_id" v-bind="categorias">
              </Multiselect>
            ...
            <div class="col-span-12  xl:col-span-6">
              ...
              <Multiselect id="familia_id" v-model="form.familia_id" v-bind="familias" @select="setCodigo">
              </Multiselect>
            ...
            <div class="col-span-12  xl:col-span-6">
              <InputLabel for="subproducto_id" value="Sub producto"
                class="block text-base font-medium leading-6 text-gray-900" />
              <Multiselect id="subproducto_id" v-model="form.subproducto_id" v-bind="subproductos" @select="setCodigo">
              </Multiselect>
            ...
            <div class="col-span-12  xl:col-span-6">
              ...
              <Multiselect id="marca_id" v-model="form.marca_id" v-bind="marcas" @select="setCodigo">
              </Multiselect>
            ...
            <div class="col-span-12  xl:col-span-6">
              ...
              <Multiselect id="peso_id" v-model="form.peso_id" v-bind="pesos" @select="setCodigo">
              </Multiselect>
            ...
            <div class="col-span-12  xl:col-span-6">
              <InputLabel for="longitud_id" value="Longitud"
                class="block text-base font-medium leading-6 text-gray-900" />
              <Multiselect id="longitud_id" v-model="form.longitud_id" v-bind="longitudes" @select="setCodigo">
              </Multiselect>
            ...
            <div class="col-span-12  xl:col-span-6">
              ...
              <Multiselect id="curva_id" v-model="form.curva_id" v-bind="curvas" @select="setCodigo">
              </Multiselect>
            ...
            <div class="col-span-12  xl:col-span-6">
              ...
              <Multiselect id="color_id" v-model="form.color_id" v-bind="colores" @select="setCodigo">
              </Multiselect>
            ...
            <div class="col-span-12  xl:col-span-6">
              <InputLabel for="diferenciador_id" value="Diferenciador"
                class="block text-base font-medium leading-6 text-gray-900" />
              <Multiselect id="diferenciador_id" v-model="form.diferenciador_id" class="dark:bg-gray-900"
