...
import CrearModal from '@/Pages/Curva/Partials/CrearModal.vue';
import EditarModal from '@/Pages/Curva/Partials/EditarModal.vue';
...
onMounted(() => {
    datos.value =usePage().props.curvas.data;
    tabla()
});
