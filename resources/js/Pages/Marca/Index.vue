...
import CrearModal from '@/Pages/Marca/Partials/CrearModal.vue';
import EditarModal from '@/Pages/Marca/Partials/EditarModal.vue';
...
onMounted(() => {
    datos.value =usePage().props.marcas.data;
    tabla()
});
