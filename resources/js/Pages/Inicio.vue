...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="px-5 col-span-full flex justify-between items-center">
            <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Panel</h1>
        </div>

        <div class="grid grid-cols-1 col-span-full gap-4 xl:grid-cols-12 xl:gap-4 mt-0 2xl:grid-cols-12" v-if="permissions.includes('cuadros')">

            <div class="col-span-1 md:col-span-3  xl:col-span-3">
                <CardDetail icon-class="fas fa-dollar-sign fa-5x" :cantidad="['$', ' ', total_ventas].join('')"
                    titulo="Ventas" :href="route('ventas.index')">
                </CardDetail>
            </div>
            <div class="col-span-1 md:col-span-3  xl:col-span-3">
                <CardDetail icon-class="fas fa-users fa-4x" :cantidad=total_clientes titulo="Clientes"
                    :href="route('clientes.index')">
                </CardDetail>
            </div>
            <div class="col-span-1 md:col-span-3  xl:col-span-3">
                <CardDetail icon-class="fas fa-shopping-cart fa-4x" :cantidad=total_productos titulo="Productos"
                    :href="route('productos.index')">
                </CardDetail>
            </div>
            <div class="col-span-1 md:col-span-3  xl:col-span-3">
                <CardDetail icon-class="fas fa-clipboard-list fa-4x" :cantidad="total_categorias" titulo="Categorías"
                    :href="route('categorias.index')">
                </CardDetail>
            </div>
        </div>

        <div  v-if="permissions.includes('graf-ventas')" class="grid grid-cols-1 col-span-full gap-4 xl:grid-cols-12 xl:gap-4 mt-0 2xl:grid-cols-12">
            <div class="col-span-1 md:col-span-3  xl:col-span-3">
        ...
        <div class="grid grid-cols-1  col-span-full gap-4 xl:grid-cols-12 xl:gap-4 mt-0 2xl:grid-cols-12">
            <!--total ventas-->
            <div v-if="permissions.includes('graf-ventas')"
            ...
            <div v-if="permissions.includes('graf-clientes')"
            ...
            <div v-if="permissions.includes('graf-vendedores')"
                class="col-span-1 md:col-span-6  xl:col-span-6 bg-white p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 dark:bg-gray-800">
            ...
            <!--total vendedidos-->
            <div
            v-if="permissions.includes('graf-vendidos')"
                class="col-span-1 md:col-span-6  xl:col-span-6 bg-white p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 dark:bg-gray-800">
            ...
            <div
            v-if="permissions.includes('graf-agregados')"
                class="col-span-1 md:col-span-6  xl:col-span-6 bg-white p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 dark:bg-gray-800">
                <h3 class="flex items-center mb-4 text-lg font-semibold text-gray-900 dark:text-white">Productos agregados
                    recientemente</h3>
                <div class="border-t border-gray-200 dark:border-gray-600">
                    <div class="pt-2" id="faq" role="tabpanel" aria-labelledby="faq-tab">
                        ...
                        <ul role="list" class="divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <li v-for="item, index in ultimos_productos" class="py-1">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center min-w-0">
                                        <img class="flex-shrink-0 w-8 h-8" :src="item.imagen_1" :alt="item.nombre">
                                        <div class="ml-3">
                                            <p class="font-normal  text-sm text-gray-900 truncate dark:text-white">
                                                {{ item.nombre }}
                                            </p>
                                    ...
                                    <div
                                        class="rounded items-center bg-yellow-300 px-1  text-sm font-normal text-gray-900 dark:text-white">
